...
function Other(){
    const [toogleOther, setToogleOther] = useState(false);
    const handleCollapseOther = () => {
      setToogleOther(!toogleOther);
      var mycollapse = document.getElementById("dropdownMenuButton");
      var bsCollapse = new Dropdown(mycollapse);
      toogleOther ? bsCollapse.show() : bsCollapse.hide();
    };
                                    ...
                                    <div class="card-body">
                                        <div class="dropdown no-arrow mb-4">
                                            <button class="btn btn-secondary dropdown-toggle" type="button"
                                                id="dropdownMenuButton" onClick={handleCollapseOther} data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Dropdown (no arrow)
                                            </button>
